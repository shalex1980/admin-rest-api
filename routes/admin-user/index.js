...
// api.createNewAdminUser("alispol.web@gmail.com", "4813wer", function(apiResponse) {
//     console.log(apiResponse)
//   })


// ADD API ENPOINT CODE HERE
        ...
        api.loginAdminUser(req.body.email, req.body.password, function(apiResponse) {
            if(!apiResponse.success) {
                ...
                const cookieSetting = {
                    ...
                    encode: String,
                    domain: process.env.NODE_ENV === "production" ? tldjs.parse(config.proAdminUrl).domain: ""
                }
                res.cookie("adminUser", apiResponse.userId + "&" + apiResponse.authToken, cookieSetting)
